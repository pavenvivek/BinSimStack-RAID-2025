...
#from inc_fns_lst_cflg_O0_O1 import *
...
if __name__ == '__main__':
    ...
    testing_fns  = fn_lst[:testing_cnt] #testing_fns_O0_O3
    validation_fns  = fn_lst[testing_cnt:(testing_cnt + validation_cnt)] #validation_fns_O0_O3
    training_fns = list(set(fn_lst) - set(testing_fns + validation_fns)) #training_fns_O0_O3
