...
if __name__ == '__main__':
    ...
    generate_training_and_testing_files_from_db(model, exp_num="1", pull_test_data_from_db=True) # pass model, experiment number as arg
