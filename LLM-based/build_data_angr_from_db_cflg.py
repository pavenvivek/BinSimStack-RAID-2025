...
def get_data_from_db():
    ...
    #for data in col1.find({"experiment" : "35"}, {"_id": 0, "testing_fns" : 1, "validation_fns": 1, "training_fns" : 1, "library" : 1, "experiment" : 1, "trs" : 1}):
    #    inc_fns = data["training_fns"] + data["testing_fns"]
    #---
    ...
    exp_num_ls = ["41-scale-O0-O3-5000"]
    ...
    for data in col.find({"library" : {'$in' : inc_libraries1}}, {"_id": 0, "graph" : 1, "ref_dict": 1, "adj_dict" : 1, "vex_ir" : 1, "calls" : 1, "consts" : 1, "instr_str" : 1, "instr_byte" : 1, "function" : 1, "filename" : 1, "transformation" : 1, "compiler" : 1, "compiler_flags" : 1, "architecture" : 1, "library" : 1, "uuid" : 1}):
       ...
       if data["compiler_flags"] not in ["O0", "O3"]:
           continue
...
if __name__ == '__main__':
    ...
    generate_data(exp_num="41-scale-O0-O3-5000", pull_test_data_from_db=False)
