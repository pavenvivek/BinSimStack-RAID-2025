...
def get_pair(Gs, classes, M, cls_st, target_cls_ind = -1, output_id = False, load_id = None, mode = None):
    ...
    if load_id is None:
        ...
        if len(cls) != 6:
            print ("class lenght != 4 -> {}".format(Gs[g0[0]].function))
            #continue
        ...
        for j in range(cls_st, cls_end):
            if j != cls_id:
                ...
                for i in range(0, len(cls2)):
                     ...
                     if Gs[cls2[i]].model == "Cirrina":
                         if Gs[cls2[i]].transformation == ["N/A"]:
                             h1_id = cls2[i]
                         elif Gs[cls2[i]].transformation == ["Flatten"]: #["EncodeArithmetic, Flatten"]: #["Flatten"]: #
                             h2_id = cls2[i]
                ...
                pos_ids.append( (c3_id, c1_id, h1_id, g3_id, g1_id, k1_id, p3_id, p1_id, l1_id) )
                ...
                ids.append((c3_id, c1_id, h1_id, g3_id, g1_id, k1_id, p3_id, p1_id, l1_id))
